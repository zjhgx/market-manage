...
public class Withdraw {
    ...
    public static Expression<BigDecimal> getWithdrawAmount(Path<Withdraw> path, CriteriaBuilder criteriaBuilder) {
        return criteriaBuilder.toBigDecimal(path.get("withdrawMoney"));
    }
